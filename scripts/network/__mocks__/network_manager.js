...
class TestNetwork {
    ...
    getTxPage = vi.fn((nStartHeight, addr, _n) => {
        if (addr === 'ofAixz87AXWaPS5qdhAHPzNWXTRd2nDdHN') {
            ...
            // tx_2 provides a spendable balance of 10000 OLC
            const tx_2 =
            ...
            addr ===
            'xpub6CrVW9bapr5XmJ6ZXBr1U6pLvsmcVg1i5tk8aZUreASriREfHa5dCKpPshg1s9i29PjCNky2Nk3bjmqjK9AuYM14f94kHGGrUu41Tn4JZQ7'
        ) {
            // 2) HD mainnet wallet
            // tx_1 provides a spendable balance of 1 * 10^8 satoshi to the address with path m/44'/119'/0'/0/0
            const tx_1 =
                '';
