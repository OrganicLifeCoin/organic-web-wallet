...
export class LedgerController {
    ...
    static LEDGER_ERRS = new Map([
        ...
        [25870, 'Open the OrganicLifeCoin app on your device'],
        [25873, 'Open the OrganicLifeCoin app on your device'],
        [57408, 'Navigate to the OrganicLifeCoin app on your device'],
        [27157, 'Wrong app! Open the OrganicLifeCoin app on your device'],
        [27266, 'Wrong app! Open the OrganicLifeCoin app on your device'],
        [27904, 'Wrong app! Open the OrganicLifeCoin app on your device'],
