...
export class Account {
     ...
     * @param {Array<Object>} [accountData.deterministicMasternodes] - Public deterministic masternode metadata.
    ...
    constructor(accountData) {
        ...
        this.deterministicMasternodes =
            accountData?.deterministicMasternodes || [];
    ...
    /** @type {Array<Object>} Public deterministic masternode metadata. */
