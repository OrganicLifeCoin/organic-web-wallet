...
/** The fee in Sats to use for Creating or Redeeming OLC Promos */
...
/**
 * Sets the mode of the OLC Promos UI
...
/**
 * Create a new 'OLC Promos' code with a webworker
    ...
    for (const cDiskCode of arrCodes.sort((a, b) => b.time - a.time)) {
        ...
        strHTML += `
             <tr>
                 <td><code id="copy${
                     cCode.address
                 }" class="wallet-code ptr" onclick="OLCWallet.toClipboard(this)" data-copy="${sanitizeHTML(
            cCode.code
            ...
            trimmedCode
                 ...
                 ${
                     fCannotDelete
                         ...
                         : '<i class="fa-solid fa-ban ptr" onclick="OLCWallet.deletePromoCode(\'' +
...
/** Export and download all OLC Promos data in to a CSV format */
export async function promosToCSV() {
    const arrCSV = [
        // Titles
        ['Promo Code', 'OLC (Remaining)', 'Funding Address'],
        // Content
    ];
        ...
        strHTML =
            `
             <tr>
                 ...
                 <td>
                    <i class="fa-solid fa-ban ptr" style="margin-right:4px;" onclick="OLCWallet.deletePromoCode('${cThread.code}')"></i>
                    ${strState}
                </td>
             </tr>
         ` + strHTML;
...
/**
 * @type {Worker?} - The thread used for the OLC Promos redeem process
 */
export let promoThread = null;

/**
 * Derive a 'OLC Promos' code with a webworker
...
/**
 * Prompt a QR scan for a OLC Promos code
 */
